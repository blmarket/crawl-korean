                  ...
                  bool check_validity)
{
    ...
    case SPELL_HELLFIRE_BURST:
        beam.aux_source   = M_("burst of hellfire");
    ...
    case SPELL_METAL_SPLINTERS:
        ...
        beam.short_name = M_("metal splinters");
               ...
               bool do_noise, bool special_ability)
{
    ...
    case SPELL_MIRROR_DAMAGE:
        simple_monster_message(mons,
                               _(" kneels in prayer and is bathed in unholy energy."),
                               MSGCH_MONSTER_SPELL);
    ...
    case SPELL_KRAKEN_TENTACLES:
    {
        ...
        {
            mpr(_("Error! Kraken is not a part of the current environment!"),
                MSGCH_ERROR);
            return;
        }
