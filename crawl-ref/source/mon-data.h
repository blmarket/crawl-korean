...
/* ******************************************************************
   ...
   (see M_("mon-util.h") for the gory details)
 ...
 - Some further explanations:
    ...
    - genus: base monster M_("type") for a classed monsters (i.e. jackal as hound)
...
// It is also a good prototype for new monsters.
{
    ...
    MONS_PROGRAM_BUG, 'B', LIGHTRED, M_("program bug"),
    // monster flags
...
{
    MONS_FIRE_BAT, 'b', ETC_FIRE, M_("fire bat"),
    M_SENSE_INVIS | M_WARM_BLOOD | M_BATTY,
...
{
    MONS_CHAOS_BUTTERFLY, 'b', ETC_RANDOM, M_("chaos butterfly"),
...
{
    MONS_GNOLL_SHAMAN, 'g', WHITE, M_("gnoll shaman"),
    M_SPELLCASTER | M_PRIEST | M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_GNOLL_SERGEANT, 'g', CYAN, M_("gnoll sergeant"),
...
{
    MONS_SPIRIT_WOLF, 'h', LIGHTMAGENTA, M_("spirit wolf"),
...
{ // dummy for giant lizard genus
    MONS_GIANT_LIZARD, 'l', LIGHTGREY, M_("giant lizard"),
...
{
    MONS_WIND_DRAKE, 'l', WHITE, M_("wind drake"),
...
{
    MONS_WATER_NYMPH, 'm', MAGENTA, M_("water nymph"),
...
// rotting monsters ('n')
{
    MONS_BOG_BODY, 'n', GREEN, M_("bog body"),
...
{
    MONS_PLAGUE_SHAMBLER, 'n', BROWN, M_("plague shambler"),
    M_NO_ZOMBIE,
    MR_RES_COLD,
...
{
    MONS_DEEP_DWARF_NECROMANCER, 'q', LIGHTBLUE, M_("deep dwarf necromancer"),
...
{
    MONS_ALLIGATOR_SNAPPING_TURTLE, 't', LIGHTGREEN, M_("alligator snapping turtle"),
    M_COLD_BLOOD,
    MR_NO_FLAGS,
...
{
    MONS_APOCALYPSE_CRAB, 't', WHITE, M_("apocalypse crab"),
...
{
    MONS_SPATIAL_MAELSTROM, 'v', YELLOW, M_("spatial maelstrom"),
...

{
    ...
    MONS_ABOMINATION_SMALL, 'x', LIGHTRED, M_("small abomination"),
    M_NO_FLAGS,
    MR_NO_FLAGS,
...
{
    MONS_ANCIENT_ZYME, 'x', GREEN, M_("ancient zyme"),
    M_SEE_INVIS,
    MR_RES_POISON,
...
{
    MONS_POLYMOTH, 'y', LIGHTBLUE, M_("polymoth"),
...
{
    MONS_SKELETON, 'z', LIGHTGREY, M_("skeleton"),
    M_NO_REGEN,
    mrd(MR_RES_COLD, 2),
...
{
    MONS_SIMULACRUM, 'z', ETC_ICE, M_("simulacrum"),
    M_NO_REGEN,
...
{
    MONS_ANCIENT_CHAMPION, 'z', ETC_GOLD, M_("ancient champion"),
...
{
    MONS_CHERUB, 'A', LIGHTBLUE, M_("cherub"),
...
{
    MONS_PROFANE_SERVITOR, 'A', ETC_BLOOD, M_("profane servitor"),
...
// elementals (E)
{ // dummy for the genus, never spawns
    MONS_ELEMENTAL, 'E', LIGHTGREY, M_("elemental"),
    M_CANT_SPAWN,
...
{
    MONS_TENGU, 'H', LIGHTBLUE, M_("tengu"),
...
{
    MONS_CHIMERA, 'H', MAGENTA, M_("chimera"),
...
{
    MONS_DJINNI, 'R', LIGHTBLUE, M_("djinni"),
    M_WARM_BLOOD | M_SPEAKS | M_NO_POLY_TO,
    MR_RES_HELLFIRE | MR_VUL_COLD,
...
// snakes ('S')
{
    MONS_BALL_PYTHON, 'S', GREEN, M_("ball python"),
    M_COLD_BLOOD,
    MR_NO_FLAGS,
...
{
    MONS_ADDER, 'S', LIGHTGREEN, M_("adder"),
    M_COLD_BLOOD,
    MR_NO_FLAGS,
...
{
    MONS_DEEP_TROLL_EARTH_MAGE, 'T', MAGENTA, M_("deep troll earth mage"),
...
{
    MONS_DEEP_TROLL_SHAMAN, 'T', WHITE, M_("deep troll shaman"),
...
{
    MONS_ANCIENT_BEAR, 'U', YELLOW, M_("ancient bear"),
    M_WARM_BLOOD | M_SPELLCASTER | M_FAKE_SPELLS | M_FLEES,
    MR_RES_FIRE,
...
{
    // See comment under MONS_ABOMINATION_SMALL regarding holiness.
    MONS_ABOMINATION_LARGE, 'X', LIGHTRED, M_("large abomination"),
    M_NO_FLAGS,
    MR_NO_FLAGS,
...
{
    MONS_THRASHING_HORROR, 'X', YELLOW, M_("thrashing horror"),
...
{
    MONS_TENTACLED_STARSPAWN, 'X', LIGHTCYAN, M_("tentacled starspawn"),
...
{
    MONS_STARSPAWN_TENTACLE, 'w', LIGHTCYAN, M_("starspawn tentacle"),
    M_NO_EXP_GAIN | M_STATIONARY | M_NO_POLY_TO,
    mrd(MR_RES_POISON, 3),
...
{
    MONS_STARSPAWN_TENTACLE_SEGMENT, '*', LIGHTCYAN, M_("starspawn tentacle segment"),
    M_NO_EXP_GAIN | M_STATIONARY | M_NO_POLY_TO,
    mrd(MR_RES_POISON, 3),
...
{
    MONS_STARCURSED_MASS, 'X', BLUE, M_("starcursed mass"),
    M_SEE_INVIS,
    mrd(MR_RES_POISON, 3),
...
{
    MONS_HELLBINDER, '@', ETC_FIRE, M_("Hellbinder"),
    M_SPELLCASTER | M_SPEAKS | M_ACTUAL_SPELLS | M_WARM_BLOOD,
    MR_NO_FLAGS,
    550, 10, MONS_HUMAN, MONS_HUMAN, MH_NATURAL, -4,
    { {AT_HIT, AF_PLAIN, 6}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
...
{
    MONS_CLOUD_MAGE, '@', ETC_SILVER, M_("Cloud Mage"),
    M_SPELLCASTER | M_SPEAKS | M_ACTUAL_SPELLS | M_WARM_BLOOD,
    MR_NO_FLAGS,
    550, 10, MONS_HUMAN, MONS_HUMAN, MH_NATURAL, -4,
    { {AT_HIT, AF_PLAIN, 6}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
...
{
    MONS_VAULT_SENTINEL, '@', LIGHTBLUE, M_("vault sentinel"),
    M_FIGHTER | M_WARM_BLOOD | M_SEE_INVIS | M_SPEAKS
...
{
    MONS_VAULT_WARDEN, '@', LIGHTRED, M_("vault warden"),
    M_FIGHTER | M_WARM_BLOOD | M_SEE_INVIS | M_SPEAKS,
    MR_NO_FLAGS,
    550, 12, MONS_HUMAN, MONS_HUMAN, MH_NATURAL, -3,
...
{
    MONS_IRONBRAND_CONVOKER, '@', YELLOW, M_("ironbrand convoker"),
    M_WARM_BLOOD | M_SPEAKS | M_SPELLCASTER | M_ACTUAL_SPELLS,
    MR_NO_FLAGS,
    550, 12, MONS_HUMAN, MONS_HUMAN, MH_NATURAL, -3,
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
...
{
    MONS_IRONHEART_PRESERVER, '@', LIGHTGREEN, M_("ironheart preserver"),
    M_WARM_BLOOD | M_SPEAKS | M_SPELLCASTER | M_ACTUAL_SPELLS,
    MR_NO_FLAGS,
    550, 12, MONS_HUMAN, MONS_HUMAN, MH_NATURAL, -3,
    { {AT_HIT, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
...
{
    MONS_RAVENOUS_ITEM_MIMIC, 'X', BLACK, M_("ravenous item mimic"),
    M_NO_FLAGS,
    MR_RES_POISON | MR_RES_ELEC | MR_RES_FIRE | MR_RES_COLD,
    0, 13, MONS_ITEM_MIMIC, MONS_ITEM_MIMIC, MH_NONLIVING, -3,
...
{
    MONS_RAVENOUS_FEATURE_MIMIC, 'X', BLACK, M_("ravenous feature mimic"),
    M_NO_FLAGS,
    MR_RES_POISON | MR_RES_ELEC | MR_RES_FIRE | MR_RES_COLD,
    0, 13, MONS_FEATURE_MIMIC, MONS_FEATURE_MIMIC, MH_NONLIVING, -3,
    { {AT_HIT, AF_PLAIN, 16}, {AT_HIT, AF_POISON, 16},
...
#if TAG_MAJOR_VERSION == 34
{
    MONS_MONSTROUS_ITEM_MIMIC, 'X', BLACK, M_("monstrous item mimic"),
    M_NO_FLAGS,
    MR_RES_POISON | MR_RES_ELEC | MR_RES_FIRE | MR_RES_COLD,
    0, 13, MONS_ITEM_MIMIC, MONS_ITEM_MIMIC, MH_NONLIVING, -3,
...
{
    MONS_CRIMSON_IMP, '5', RED, M_("crimson imp"),
    M_SPEAKS,
    MR_RES_POISON | MR_RES_HELLFIRE | MR_VUL_COLD,
...
// devils etc. ('4')
{
    MONS_BLUE_DEVIL, '4', BLUE, M_("blue devil"),
    M_NO_FLAGS,
    MR_RES_POISON | MR_VUL_FIRE | mrd(MR_RES_COLD, 3),
...
{
    MONS_IRON_DEVIL, '4', CYAN, M_("iron devil"),
    M_NO_FLAGS,
    MR_RES_POISON | mrd(MR_RES_ELEC, 2) | MR_RES_HELLFIRE | MR_RES_COLD,
...
{
    MONS_ORANGE_DEMON, '4', LIGHTRED, M_("orange demon"),
    M_NO_FLAGS,
    MR_NO_FLAGS,
...
// middle demons ('3')
{
    MONS_SUN_DEMON, '3', YELLOW, M_("sun demon"),
...
{
    MONS_SOUL_EATER, '3', MAGENTA, M_("soul eater"),
    M_SPELLCASTER | M_SEE_INVIS,
    MR_RES_POISON | MR_RES_COLD,
...
{
    MONS_ICE_DEVIL, '3', WHITE, M_("ice devil"),
    M_NO_FLAGS,
    MR_RES_POISON | MR_VUL_FIRE | mrd(MR_RES_COLD, 3),
...
{
    MONS_SHADOW_DEMON, '2', MAGENTA, M_("shadow demon"),
    M_SPELLCASTER | M_SEE_INVIS,
    MR_RES_POISON | mrd(MR_RES_COLD, 2),
...
{
    MONS_BLIZZARD_DEMON, '2', LIGHTBLUE, M_("blizzard demon"),
    M_SPELLCASTER | M_SEE_INVIS,
...
{
    MONS_CACODEMON, '2', YELLOW, M_("cacodemon"),
    M_SPELLCASTER | M_SEE_INVIS,
    MR_RES_POISON | MR_RES_ELEC,
...
{
    MONS_TORMENTOR, '2', LIGHTMAGENTA, M_("tormentor"),
    M_SPELLCASTER | M_SPEAKS,
    MR_RES_POISON | MR_RES_FIRE,
...
// fiends, etc. ('1')
{
    MONS_BRIMSTONE_FIEND, '1', LIGHTRED, M_("Brimstone Fiend"),
    M_SPELLCASTER | M_SEE_INVIS | M_GLOWS_LIGHT,
    MR_RES_POISON | MR_RES_HELLFIRE | MR_VUL_COLD,
...
{   // dummy for transformed display
    MONS_ANIMATED_TREE, '7', ETC_TREE, M_("animated tree"),
...
{
    MONS_DIAMOND_OBELISK, '8', WHITE, M_("diamond obelisk"),
...
{
    MONS_LOST_SOUL, '*', LIGHTGREEN, M_("lost soul"),
...
{
    MONS_LURKING_HORROR, '*', BLUE, M_("lurking horror"),
...
{ // not an actual monster, used by a spell
    MONS_FULMINANT_PRISM, '*', ETC_MAGIC, M_("fulminant prism"),
...
{
    MONS_WRETCHED_STAR, '*', MAGENTA, M_("wretched star"),
    M_SPELLCASTER | M_SEE_INVIS | M_INSUBSTANTIAL | M_GLOWS_LIGHT
        | M_GLOWS_RADIATION,
    mrd(MR_RES_POISON | MR_RES_ELEC, 1) | MR_RES_FIRE | MR_RES_COLD,
...
{
    MONS_BATTLESPHERE, '*', ETC_MAGIC, M_("battlesphere"),
...
{
    MONS_SERPENT_OF_HELL, 'D', ETC_FIRE, M_("the Serpent of Hell"),
...
{
    MONS_SERPENT_OF_HELL_COCYTUS, 'D', ETC_ICE, M_("the Serpent of Hell"),
    M_SPELLCASTER | M_SEE_INVIS | M_UNIQUE | M_FAKE_SPELLS,
...
{
    MONS_SERPENT_OF_HELL_DIS, 'D', ETC_IRON, M_("the Serpent of Hell"),
    M_SPELLCASTER | M_SEE_INVIS | M_UNIQUE | M_FAKE_SPELLS,
    MR_RES_POISON | MR_RES_FIRE | MR_RES_COLD,
    0, 18, MONS_DRAGON, MONS_SERPENT_OF_HELL, MH_DEMONIC, -7,
    { {AT_BITE, AF_PLAIN, 35}, {AT_CLAW, AF_PLAIN, 15},
...
{
    MONS_SERPENT_OF_HELL_TARTARUS, 'D', ETC_DEATH, M_("the Serpent of Hell"),
    M_SPELLCASTER | M_SEE_INVIS | M_UNIQUE | M_FAKE_SPELLS,
    MR_RES_POISON | mrd(MR_RES_COLD, 2),
    0, 18, MONS_DRAGON, MONS_SERPENT_OF_HELL, MH_DEMONIC, -7,
    { {AT_BITE, AF_PLAIN, 35}, {AT_CLAW, AF_PLAIN, 15},
...
{
    MONS_FANNAR, 'e', LIGHTBLUE, M_("Fannar"),
    M_UNIQUE | M_SPELLCASTER | M_ACTUAL_SPELLS | M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_JORGRUN, 'q', LIGHTMAGENTA, M_("Jorgrun"),
    M_UNIQUE | M_SPELLCASTER | M_ACTUAL_SPELLS | M_WARM_BLOOD | M_SPEAKS
        | M_NO_REGEN,
    MR_NO_FLAGS,
