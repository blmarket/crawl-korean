...
const Branch branches[NUM_BRANCHES] = {
    ...
    { BRANCH_ECUMENICAL_TEMPLE, BRANCH_MAIN_DUNGEON, 4, 7, 1, 5,
      ...
      M_("Temple"), M_("the Ecumenical Temple"), "Temple",
      NULL,
    ...
    { BRANCH_ORCISH_MINES, BRANCH_MAIN_DUNGEON, 6, 11, 4, 8,
      ...
      M_("Orcish Mines"), M_("the Orcish Mines"), "Orc",
      NULL,
      true, BROWN, BROWN,
    ...
    { BRANCH_ELVEN_HALLS, BRANCH_ORCISH_MINES, 3, 4, 3, 15,
      ...
      M_("Elven Halls"), M_("the Elven Halls"), "Elf",
      NULL,
    ...
    { BRANCH_DWARVEN_HALL, BRANCH_ELVEN_HALLS, 2, 2, 1, 17,
      ...
      M_("Dwarven Hall"), M_("the Dwarven Hall"), "Dwarf",
      NULL,
      true, BROWN, BROWN,
    ...
    { BRANCH_LAIR, BRANCH_MAIN_DUNGEON, 8, 13, 8, 10,
      ...
      M_("Lair"), M_("the Lair of Beasts"), "Lair",
      NULL,
      true, GREEN, BROWN,
    ...
    { BRANCH_SHOALS, BRANCH_LAIR, 3, 6, 5, 15,
      ...
      M_("Shoals"), M_("the Shoals"), "Shoals",
      NULL,
      true, BROWN, BROWN,
    ...
    { BRANCH_SNAKE_PIT, BRANCH_LAIR, 3, 6, 5, 15,
      ...
      M_("Snake Pit"), M_("the Snake Pit"), "Snake",
      NULL,
    ...
    { BRANCH_SPIDER_NEST, BRANCH_LAIR, 3, 6, 5, 15,
      ...
      M_("Spider Nest"), M_("the Spider Nest"), "Spider",
      NULL,
      true, BROWN, YELLOW,
    ...
    { BRANCH_SLIME_PITS, BRANCH_LAIR, 6, 8, 6, 17,
      ...
      M_("Slime Pits"), M_("the Pits of Slime"), "Slime",
      NULL,
      true, GREEN, BROWN,
    ...
    { BRANCH_VAULTS, BRANCH_MAIN_DUNGEON, 14, 19, 8, 16,
      ...
      M_("Vaults"), M_("the Vaults"), "Vaults",
      NULL,
      true, LIGHTGREY, BROWN,
    ...
    { BRANCH_HALL_OF_BLADES, BRANCH_VAULTS, 4, 6, 1, 21,
      ...
      M_("Hall of Blades"), M_("the Hall of Blades"), "Blade",
      NULL,
      true, LIGHTGREY, BROWN,
    ...
    { BRANCH_TOMB, BRANCH_CRYPT, 2, 3, 3, 21,
      ...
      M_("Tomb"), M_("the Tomb of the Ancients"), "Tomb",
      NULL,
      true, BROWN, BROWN,
    ...
    { BRANCH_VESTIBULE_OF_HELL, NUM_BRANCHES, 27, 27, 1, 27,
      ...
      "Hell", M_("the Vestibule of Hell"), "Hell",
      NULL,
    ...
    { BRANCH_DIS, BRANCH_VESTIBULE_OF_HELL, 1, 1, 7, 28,
      ...
      M_("Dis"), M_("the Iron City of Dis"), "Dis",
      NULL,
      false, CYAN, BROWN,
    ...
    { BRANCH_HALL_OF_ZOT, BRANCH_MAIN_DUNGEON, 27, 27, 5, 27,
      ...
      M_("Zot"), M_("the Realm of Zot"), "Zot",
      NULL,
    ...
    { BRANCH_FOREST, BRANCH_MAIN_DUNGEON, 3, 6, 5, 16,
      ...
      M_("Forest"), M_("the Enchanted Forest"), "Forest",
      NULL,
      true, BROWN, BROWN,
    ...
    { BRANCH_TROVE, NUM_BRANCHES, -1, -1, 1, 18,
      BFLAG_NO_XLEV_TRAVEL | BFLAG_NO_ITEMS, 0,
      DNGN_ENTER_PORTAL_VAULT, DNGN_EXIT_PORTAL_VAULT,
      M_("Trove"), M_("a treasure trove"), "Trove",
      NULL,
      false, DARKGREY, BLUE,
      mons_null_rare, mons_null_level,
      '2', false, 0 },
    ...
    { BRANCH_OSSUARY, NUM_BRANCHES, -1, -1, 1, 6,
      BFLAG_NO_XLEV_TRAVEL | BFLAG_NO_ITEMS, 0,
      DNGN_ENTER_PORTAL_VAULT, DNGN_EXIT_PORTAL_VAULT,
      M_("Ossuary"), M_("an ossuary"), "Ossuary",
      NULL,
      false, WHITE, YELLOW,
    ...
    { BRANCH_ICE_CAVE, NUM_BRANCHES, -1, -1, 1, 15,
          BFLAG_NO_XLEV_TRAVEL | BFLAG_NO_ITEMS, 0,
      DNGN_ENTER_PORTAL_VAULT, DNGN_EXIT_PORTAL_VAULT,
      M_("Ice Cave"), M_("an ice cave"), "IceCv",
      NULL,
      false, BLUE, WHITE,
    ...
    { BRANCH_VOLCANO, NUM_BRANCHES, -1, -1, 1, 14,
      BFLAG_NO_XLEV_TRAVEL | BFLAG_NO_ITEMS, 0,
      DNGN_ENTER_PORTAL_VAULT, DNGN_EXIT_PORTAL_VAULT,
      M_("Volcano"), M_("a volcano"), "Volcano",
      NULL,
      false, RED, RED,
    ...
    { BRANCH_WIZLAB, NUM_BRANCHES, -1, -1, 1, 24,
      BFLAG_NO_XLEV_TRAVEL | BFLAG_NO_ITEMS, 0,
      DNGN_ENTER_PORTAL_VAULT, DNGN_EXIT_PORTAL_VAULT,
      M_("Wizlab"), M_("a wizard's laboratory"), "WizLab",
      NULL,
