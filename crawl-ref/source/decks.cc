...
const char* card_name(card_type card)
{
    switch (card)
    {
    case CARD_PORTAL:          return M_("the Portal");
    case CARD_WARP:            return M_("the Warp");
    case CARD_SWAP:            return M_("Swap");
    case CARD_VELOCITY:        return M_("Velocity");
    case CARD_DAMNATION:       return M_("Damnation");
    case CARD_SOLITUDE:        return M_("Solitude");
    case CARD_ELIXIR:          return M_("the Elixir");
    case CARD_BATTLELUST:      return M_("Battlelust");
    case CARD_METAMORPHOSIS:   return M_("Metamorphosis");
    case CARD_HELM:            return M_("the Helm");
    case CARD_BLADE:           return M_("the Blade");
    case CARD_SHADOW:          return M_("the Shadow");
    case CARD_POTION:          return M_("the Potion");
    case CARD_FOCUS:           return M_("Focus");
    case CARD_SHUFFLE:         return M_("Shuffle");
    case CARD_EXPERIENCE:      return M_("Experience");
    case CARD_HELIX:           return M_("the Helix");
    case CARD_SAGE:            return M_("the Sage");
    case CARD_DOWSING:         return M_("Dowsing");
    case CARD_TROWEL:          return M_("the Trowel");
    case CARD_MINEFIELD:       return M_("the Minefield");
    case CARD_STAIRS:          return M_("the Stairs");
    case CARD_GENIE:           return M_("the Genie");
    case CARD_TOMB:            return M_("the Tomb");
    case CARD_WATER:           return M_("Water");
    case CARD_GLASS:           return M_("Vitrification");
    case CARD_BANSHEE:         return M_("the Banshee");
    case CARD_WILD_MAGIC:      return M_("Wild Magic");
    case CARD_CRUSADE:         return M_("the Crusade");
    case CARD_SUMMON_ANIMAL:   return M_("the Herd");
    case CARD_SUMMON_DEMON:    return M_("the Pentagram");
    case CARD_SUMMON_WEAPON:   return M_("the Dance");
    case CARD_SUMMON_FLYING:   return M_("Foxfire");
    case CARD_SUMMON_SKELETON: return M_("the Bones");
    case CARD_SUMMON_UGLY:     return M_("Repulsiveness");
    case CARD_XOM:             return M_("Xom");
    case CARD_FAMINE:          return M_("Famine");
    case CARD_FEAST:           return M_("the Feast");
    case CARD_WARPWRIGHT:      return M_("Warpwright");
    case CARD_FLIGHT:          return M_("Flight");
    case CARD_VITRIOL:         return M_("Vitriol");
    case CARD_FLAME:           return M_("Flame");
    case CARD_FROST:           return M_("Frost");
    case CARD_VENOM:           return M_("Venom");
    case CARD_SPARK:           return M_("the Spark");
    case CARD_HAMMER:          return M_("the Hammer");
    case CARD_PAIN:            return M_("Pain");
    case CARD_TORMENT:         return M_("Torment");
    case CARD_BARGAIN:         return M_("the Bargain");
    case CARD_WRATH:           return M_("Wrath");
    case CARD_WRAITH:          return M_("the Wraith");
    case CARD_CURSE:           return M_("the Curse");
    case CARD_SWINE:           return M_("the Swine");
...
bool deck_deal()
{
    const int slot = _choose_inventory_deck(_("Deal from which deck?"));
    if (slot == -1)
    {
        crawl_state.zero_turns_taken();
        return false;
    ...
    {
        mpr(_("You cannot deal from marked decks."));
        crawl_state.zero_turns_taken();
        return false;
    }
    if (props["stacked"].get_bool())
    {
        mpr(_("This deck seems insufficiently random for dealing."));
        crawl_state.zero_turns_taken();
        return false;
    }
    ...
    if (num_to_deal < 4)
    {
        mpr(_("Nemelex gives you another card to finish dealing."));
...
void draw_from_deck_of_punishment(bool deal)
{
    ...
    mpr(deal ? _("You deal a card...") : _("You draw a card..."));
...
static void _remove_bad_mutation()
{
    ...
    if (!delete_mutation(RANDOM_BAD_MUTATION, "helix card", false, false, false, true))
        mpr(_("You feel transcendent for a moment."));
}
...
void sage_card(int power, deck_rarity_type rarity)
{
    ...
    else
    {
        ...
        mprf(MSGCH_PLAIN, _("You feel studious about %s."), skill_name(result));
...
static void _trowel_card(int power, deck_rarity_type rarity)
{
    ...
    if (p.origin()) // can't happen outside wizmode
        return mpr(_("The dungeon trembles momentarily."));
    ...
    if (power_level >= 2 && crawl_state.game_standard_levelgen())
    {
        ...
        if (tries > -1)
            mpr(_("A portal flickers into view, then vanishes."));
        else
...
static void _alchemist_card(int power, deck_rarity_type rarity)
{
    ...
    if (gold_used > 0)
        mprf(_("%d of your gold pieces vanish!"), gold_used);
    else
        canned_msg(MSG_NOTHING_HAPPENS);
}
