...
const char* card_name(card_type card)
{
    switch (card)
    {
    case CARD_PORTAL:          return N_("the Portal");
    case CARD_WARP:            return N_("the Warp");
    case CARD_SWAP:            return N_("Swap");
    case CARD_VELOCITY:        return N_("Velocity");
    case CARD_DAMNATION:       return N_("Damnation");
    case CARD_SOLITUDE:        return N_("Solitude");
    case CARD_ELIXIR:          return N_("the Elixir");
    case CARD_BATTLELUST:      return N_("Battlelust");
    case CARD_METAMORPHOSIS:   return N_("Metamorphosis");
    case CARD_HELM:            return N_("the Helm");
    case CARD_BLADE:           return N_("the Blade");
    case CARD_SHADOW:          return N_("the Shadow");
    case CARD_POTION:          return N_("the Potion");
    case CARD_FOCUS:           return N_("Focus");
    case CARD_SHUFFLE:         return N_("Shuffle");
    case CARD_EXPERIENCE:      return N_("Experience");
    case CARD_HELIX:           return N_("the Helix");
    case CARD_SAGE:            return N_("the Sage");
    case CARD_DOWSING:         return N_("Dowsing");
    case CARD_TROWEL:          return N_("the Trowel");
    case CARD_MINEFIELD:       return N_("the Minefield");
    case CARD_STAIRS:          return N_("the Stairs");
    case CARD_GENIE:           return N_("the Genie");
    case CARD_TOMB:            return N_("the Tomb");
    case CARD_WATER:           return N_("Water");
    case CARD_GLASS:           return N_("Vitrification");
    case CARD_MAP:             return N_("the Map");
    case CARD_BANSHEE:         return N_("the Banshee");
    case CARD_WILD_MAGIC:      return N_("Wild Magic");
    case CARD_CRUSADE:         return N_("the Crusade");
    case CARD_SUMMON_ANIMAL:   return N_("the Herd");
    case CARD_SUMMON_DEMON:    return N_("the Pentagram");
    case CARD_SUMMON_WEAPON:   return N_("the Dance");
    case CARD_SUMMON_FLYING:   return N_("Foxfire");
    case CARD_SUMMON_SKELETON: return N_("the Bones");
    case CARD_SUMMON_UGLY:     return N_("Repulsiveness");
    case CARD_SUMMON_ANY:      return N_("Summoning");
    case CARD_XOM:             return N_("Xom");
    case CARD_FAMINE:          return N_("Famine");
    case CARD_FEAST:           return N_("the Feast");
    case CARD_WARPWRIGHT:      return N_("Warpwright");
    case CARD_FLIGHT:          return N_("Flight");
    case CARD_VITRIOL:         return N_("Vitriol");
    case CARD_FLAME:           return N_("Flame");
    case CARD_FROST:           return N_("Frost");
    case CARD_VENOM:           return N_("Venom");
    case CARD_SPARK:           return N_("the Spark");
    case CARD_HAMMER:          return N_("the Hammer");
    case CARD_PAIN:            return N_("Pain");
    case CARD_TORMENT:         return N_("Torment");
    case CARD_SPADE:           return N_("the Spade");
    case CARD_BARGAIN:         return N_("the Bargain");
    case CARD_WRATH:           return N_("Wrath");
    case CARD_WRAITH:          return N_("the Wraith");
    case CARD_CURSE:           return N_("the Curse");
    case CARD_SWINE:           return N_("the Swine");
    case CARD_ALCHEMIST:       return N_("the Alchemist");
    case CARD_ORB:             return N_("the Orb");
    case NUM_CARDS:            return N_("a buggy card");
    }
    return N_("a very buggy card");
}
