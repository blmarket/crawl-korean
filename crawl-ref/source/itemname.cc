...
static const char* scroll_type_name(int scrolltype)
{
    ...
    case SCR_BRAND_WEAPON:       return M_("brand weapon");
...
static const char* jewellery_type_name(int jeweltype)
{
    ...
    case RING_LIFE_PROTECTION:       return M_("ring of positive energy");
...
#endif
    case MISC_FAN_OF_GALES:              return M_("fan of gales");
    ...
    case OBJ_FOOD:
        ...
        case FOOD_CHUNK:
            if (!basename && !dbname)
            {
				...
				{
					buff << _(mons_type_name(static_cast<monster_type>(it_plus), DESC_PLAIN).c_str()) << " 고기";
				}
            }
            else
